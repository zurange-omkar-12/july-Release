...
public class orangeHRM_Dashboard_Page extends Base_Class_init {
	...
	public void Dashboard_Page_Logout() {
		
		wait_Obj.until(ExpectedConditions.visibilityOf(userdropdown)).click();
		wait_Obj.until(ExpectedConditions.visibilityOf(Logout)).click();
	...
	public void capture_Dashboard_Page_Screenshot() {
		...
		File Target = new File(
				System.getProperty("user.dir") + "/Screenshots/Valid" + random_int_Obj.nextInt(10000) + ".png");
